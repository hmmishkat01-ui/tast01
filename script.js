...
(function () {
  ...
  // স্কোর ব্যান্ড: 0-6 (নিরাপদ), 7-12 (সিমপ্যাথেটিক), 13-18 (ডরসাল), 19-24 (ক্রিটিক্যাল)
  const categories = [
    { max: 6,  icon: 'fa-leaf', color: '#10b981', soft: '#ecfdf5', ring: '#a7f3d0',
      title: 'ভেন্ট্রাল ভেগাল মোড (নিরাপদ ও সুস্থ অবস্থা)',
      body: 'আপনার ভাইটাল ফোর্স তুলনামূলকভাবে সুস্থ আছে। আপনি সামাজিক সংযোগ অনুভব করতে পারছেন এবং আপনার স্নায়ুতন্ত্র নিরাপদ মোডে (Safe & Social) কাজ করছে। বইয়ের লাইফস্টাইল রিপ্রোগ্রামিং এবং মাইন্ডফুলনেস অনুশীলনগুলো নিয়মিত ফলো করে এই সুস্থতা ধরে রাখুন।' },
    { max: 12, icon: 'fa-bolt', color: '#f59e0b', soft: '#fffbeb', ring: '#fcd34d',
      title: 'সিমপ্যাথেটিক মোড (যুদ্ধ বা উত্তেজনা মোড)',
      body: 'আপনার স্নায়ুতন্ত্র ক্রমাগত বিপদ সংকেত পাঠাচ্ছে। আপনি সবসময় উদ্বিগ্ন, অস্থির, অতিরিক্ত চিন্তাশীল এবং সতর্ক অবস্থায় আছেন। এই মোডে দীর্ঘদিন থাকলে প্যানিক অ্যাটাক, অনিদ্রা, হাইপারটেনশন এবং হৃদরোগের ঝুঁকি বাড়ে। আপনার ভাইটাল ফোর্স উত্তেজিত অবস্থায় আছে। একজন অভিজ্ঞ চিকিৎসকের 3D Healing Protocol (বিশেষ করে NRT এবং সোমাটিক রিলিজ) আপনাকে দ্রুত নিরাপদ মোডে ফিরিয়ে আনতে পারে।' },
    { max: 18, icon: 'fa-cloud-moon', color: '#f97316', soft: '#fff7ed', ring: '#fed7aa',
      title: 'ডরসাল ভেগাল মোড (শাটডাউন বা অবসাদ মোড)',
      body: 'আপনার শরীর ও মন একটি গভীর শাটডাউন (Freeze) অবস্থায় আটকে আছে। আপনি অনুভূতিহীন, বিচ্ছিন্ন, ক্লান্ত এবং জীবনের প্রতি আগ্রহ হারিয়ে ফেলেছেন। এটি ট্রমার একটি গভীর স্তর। এই অবস্থায় শুধু ওষুধ বা শুধু কাউন্সেলিং—কোনোটিই একা যথেষ্ট নয়। আপনার প্রয়োজন 3D Healing Blueprint™ (হোমিওপ্যাথি + সাইকোথেরাপি + লাইফস্টাইল ইন্টারভেনশন)। দয়া করে দেরি করবেন না, সাহায্য নিন।' },
    { max: 24, icon: 'fa-hand-holding-heart', color: '#ef4444', soft: '#fef2f2', ring: '#fca5a5',
      title: 'গুরুতর ডিসরেগুলেশন বা ক্রিটিক্যাল অবস্থা',
      body: 'আপনার অবস্থা অত্যন্ত গুরুতর। আপনার শান্তি-স্নায়ু এবং ভাইটাল ফোর্স গভীরভাবে ক্ষতিগ্রস্ত হয়েছে এবং সিস্টেমটি কোলাপসের পথে। এটি একটি মেডিক্যাল এবং সাইকোলজিক্যাল ইমার্জেন্সি। আজই একজন অভিজ্ঞ ইন্টিগ্রেটেড মেন্টাল হেলথ প্র্যাকটিশনারের সাথে সরাসরি যোগাযোগ করুন। মনে রাখবেন, আপনি একা নন। সুস্থ হওয়ার পথ আছে, এবং সাহায্য আপনার হাতের মুঠোয়।' },
  ];
  ...
  function renderResult() {
    ...
    // বিশেষ দ্রষ্টব্য: স্নায়ুতন্ত্র সিমপ্যাথেটিক ও ডরসাল-এর মধ্যে দোল খাচ্ছে?
    // (স্কোর ঠিক ১২ বা ১৩, এবং 'খ' ও 'গ' উত্তরের সংখ্যা সমান)
    const khoCount = answers.filter((v) => v === 1).length;
    const goCount = answers.filter((v) => v === 2).length;
    const oscillating = (total === 12 || total === 13) && khoCount === goCount;
    const note = document.getElementById('oscillation-note');
    note.classList.toggle('hidden', !oscillating);
    note.classList.toggle('flex', oscillating);
